...
Maintainers may use generative AI tools as assistants while working on gnome-control-center. Non-trivial assisted commits disclose the tool, model, and scope of the work.
